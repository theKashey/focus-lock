...
const findAutoFocused = (autoFocusables: Element[]) => (node: Element): boolean =>
  // @ts-expect-error
...
export const getFocusMerge = (topNode: Element | Element[], lastNode: Element | null): undefined | { node: HTMLElement } => {
